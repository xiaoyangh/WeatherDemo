...
//     NSString *tempStr=[NSString stringWithFormat:@"%.2f",[tmp floatValue]];
    // 最高最低温度标签
    NSString *maxTmp = [NSString stringWithFormat:@"%.2f°",[dailyForecast.tmp.max floatValue]];
    NSString *minTmp = [NSString stringWithFormat:@"%.2f°",[dailyForecast.tmp.min floatValue]];
