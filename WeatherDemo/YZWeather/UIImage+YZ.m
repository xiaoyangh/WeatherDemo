...
//    NSArray *condArray = [NSArray arrayWithObjects:@"阵雨",@"多云",@"晴间多云",@"阴",@"晴",@"雷阵雨",@"雨夹雪",@"阵雨夹雪",@"雨雪天气",@"霾",@"扬沙",@"浮尘",@"沙尘暴",@"强沙尘暴",@"小雨",@"中雨",@"大雨",@"极端降雨",@"暴雨",@"大暴雨",@"特大暴雨",@"小雪",@"中雪",@"大雪",@"暴雪",@"少云",nil];
    NSArray *condArray = [NSArray arrayWithObjects:@"shower rain",@"broken clouds",@"晴few clouds",@"scattered clouds",@"clear sky",@"shower rain",@"snow",@"snow",@"snow",@"mist",@"mist",@"mist",@"mist",@"mist",@"shower rain",@"shower rain",@"rain",@"rain",@"thunderstorm",@"thunderstorm",@"thunderstorm",@"snow",@"snow",@"snow",@"snow",@"few clouds",nil];
    
    NSInteger index = [condArray indexOfObject:condString];
    if (index>condArray.count )
    {
        if ([condString containsString:@"rain"])
        {
