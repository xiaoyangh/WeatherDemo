...
//        self.condImageView.backgroundColor = [UIColor redColor];
        ...
        NSString *maxTmp = [NSString stringWithFormat:@"%.2f°",[today.tmp.max floatValue]];
        NSString *minTmp = [NSString stringWithFormat:@"%.2f°",[today.tmp.min floatValue]];
        ...
        [GMDCircleLoader setOnView:self withTitle:@"loading..." animated:YES];
    }
}
